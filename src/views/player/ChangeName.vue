<template>
  <div>
    ...
    <form @submit.prevent="doChangeName">
      <p class="input-field">
        <input type="text" inputmode="decimal" id="new_user_name" name="new_user_name" v-model="new_user_name" :disabled="fetching" @input="usernameInput" maxlength="8" data-length="8"/>
